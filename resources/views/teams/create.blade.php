        ...
        <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
            <div class="rounded-xl bg-white shadow-xl">
                <div class="p-6 sm:p-8">
                    <div class="space-y-4">
                        <h2 class="mb-8 text-2xl text-cyan-900 font-bold">New Team:</h2>
                    </div>
...
<a href="{{ route('teams.index') }}" class="block mt-4 text-sm text-gray-600 underline">Go back to Team List</a>
@endsection
