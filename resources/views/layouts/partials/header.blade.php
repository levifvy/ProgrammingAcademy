        ...
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                <a href="{{route('sites')}}">
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 font-semibold text-2xl tracking-tight">Programming Academy T&C</span>
                    </div>
                </a>
            </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-xl lg:flex-grow flex justify-center">
                    ...
                    <a href="{{route('rules')}}"           class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 {{request()->routeIs('rules') ? 'active':''}}">Plans</a>
                    ...
                    <a href="{{route('ourteam')}}"           class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 {{request()->routeIs('about') ? 'active':''}}">Team</a>
            ...
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                <a href="https://elpuig.xeill.net/" target="-blanck">
                    <div class="flex items-center">
                        <img class="bg-transparent" src="{{asset('/img/puig.jpg')}}" alt="image" loading="lazy" width="50" height="50"><br>
                        {{--<svg class="h-10 w-10 text-slate-700"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="12" r="9" />    <path d="M12 12a8 8 0 0 0 8 4M7.5 13.5a12 12 0 0 0 8.5 6.5" />    <path d="M12 12a8 8 0 0 0 8 4M7.5 13.5a12 12 0 0 0 8.5 6.5" transform="rotate(120 12 12)" />    <path d="M12 12a8 8 0 0 0 8 4M7.5 13.5a12 12 0 0 0 8.5 6.5" transform="rotate(240 12 12)" /></svg> --}}
                        <span class="ml-4 font-semibold text-2xl tracking-tight">Institute "El Puig"</span>
                    </div>
                </a>
            </div>
        </nav>
