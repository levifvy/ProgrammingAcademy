        ...
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-xl lg:flex-grow flex justify-center">
                    ...
                    <a href="{{route('categories.index')}}"     class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 {{request()->routeIs('categories.index*') ? 'active':''}}">Staff</a>
                    <a href="{{route('games.index')}}"        class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 {{request()->routeIs('games.index*') ? 'active':''}}">Courses</a>
